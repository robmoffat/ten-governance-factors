...
Staff and technology are both employed to perform those activities; governance exists to ensure they are 
...
<RevealItem title="Human and automated work">

Modern systems increasingly delegate decisions to software, workflows and AI
agents. A sensitive activity could comprise of work done by humans, rules engines, machinery,
a data processing pipeline or a large language model.
...
Modern enterprises increasingly rely on automated and AI systems to approve
