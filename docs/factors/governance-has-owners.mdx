...
tags:
  - Factor
principle: "Every governed thing must have accountable humans."
---

<GovernanceFactor title="Governance Has Owners">
...
- A repo with a named owning team
- An AI-agent twin with an approver and escalation path
- A data product with a risk owner
- A service catalogue entry with steward and contact
- Time-bounded exceptions assigned to named approvers

</PositiveExamples>

<NegativeExamples>

- “Platform owns it” with no person or team
- Orphaned agents
- Datasets with no steward
- Expired exceptions with no reviewer
- Incident actions assigned to nobody
...
Ownership connects things to accountable humans: owners, approvers and escalation paths.
