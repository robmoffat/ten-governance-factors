---
sidebar_position: 5
title: Context In, Decisions Out
sidebar_label: V. Context In, Decisions Out
hide_title: true
tags:
  - Factor
description: "Governance decisions are explicit functions over context that returns a deterministic, inspectable decision result."
---
...
A visible decision boundary—context in, permit/deny/obligations out—turns
...
<RevealItem title="Structured context" defaultOpen>
...
<RevealItem title="Assumptions instead of context">
...
<Diagram
  ...
  description="Context enters a policy boundary; an explicit decision, action and explanation come out."
>

```mermaid
flowchart LR
  Context["Context<br/>principal · action · resource · context"] --> Policy
